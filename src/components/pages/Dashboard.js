...
function Dashboard(props){
  const { parents, teachers, classes, students } = props;
        ...
        <div className="content">
                  ...
                  <Row>
                    ...
                    <Col md="8" xs="7">
                      <div className="numbers">
                        ...
                        <CardTitle>{parents.length}</CardTitle>
                        <p />
                      </div>
                    </Col>
                  </Row>
              ...
              <Card className="card-stats">
                <CardBody>
                  <Row>
                    ...
                    <Col md="8" xs="7">
                      <div className="numbers">
                        <p className="card-category">Classes</p>
                        <CardTitle>{classes.length}</CardTitle>
                        <p />
                      </div>
                    </Col>
                  </Row>
          ...
          <Col md="12">
              <Card className="card-chart">
                <CardHeader>
                  <CardTitle tag="h6">Invoices Paid</CardTitle>
                  <p className="card-category">Payments for this year</p>
                </CardHeader>
                <CardBody>
                  <Line
                    data={dashboardInvoices.data}
                    options={dashboardInvoices.options}
                    width={400}
                    height={100}
                  />
                </CardBody>
