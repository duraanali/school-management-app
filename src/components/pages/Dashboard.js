              ...
              <Card>
                ...
                <Table responsive>
                    ...
                    return <tr>
                        ...
                        <td key={student.id}><Link to={`/studentedit/${student.id}`}><Button color="success" active> Edit </Button></Link> <Link to={`/studentedit/${student.id}`}><Button color="danger" active> Delete </Button></Link></td>
                      </tr>
                           })}
                    </tbody>
                  </Table>
